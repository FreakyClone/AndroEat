...
public class SignUp extends AppCompatActivity {
    ...
    MaterialEditText OnixPhone,OnixName,OnixPassword;
    Button btnSignUp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OnixName = (MaterialEditText)findViewById(R.id.OnixName);
                ...
                table_user.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.child(OnixPhone.getText().toString()).exists())
                        {
                            ...
                            mDialog.dismiss();
                            User user = new User(OnixName.getText().toString(),OnixPassword.getText().toString());
                            table_user.child(OnixPhone.getText().toString()).setValue(user);
